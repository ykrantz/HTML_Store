...
let item_list = [];
let item_cart = [];
let item_remove_counter = new Item_press_counter("", 0);
...
function Item_press_counter(item_id, press_counter) {
  this.item_id = item_id;
  this.press_counter = press_counter;
}
// **********
// level 01- main:
// **********
...
function reduce_from_cart_if_double_press(ev) {
  ...
  if (item_pressed_id != undefined) {
    ...
    console.log("you didn't press a specific item");
  }
}
